...
<!-- Filterizr -->
<script src="{{asset('website/backend/plugins/filterizr/jquery.filterizr.min.js')}}"></script>
<!-- Ekko Lightbox -->
<script src="{{asset('website/backend/plugins/ekko-lightbox/ekko-lightbox.min.js')}}"></script>
<script>
    $(function () {
